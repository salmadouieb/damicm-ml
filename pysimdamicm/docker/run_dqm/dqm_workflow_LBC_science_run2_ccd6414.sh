...
echo " Exporting TAG, CCDname, OFFSET"
...
echo `which dqmSKImg`
export DATA_DIR=/data/fits/2022-05-10-science-ccd6414
export OUT_DIR=/home/wuser/workdir/dqm_manual/science-run2/ccd${CCDNAME}

export MEJSON=/home/wuser/workdir/dqm_manual/science-run2/dqmSKImg_configuration.json
export JSON=/home/wuser/workdir/dqm_manual/science-run2/panaSKImg_configuration_6414.json
